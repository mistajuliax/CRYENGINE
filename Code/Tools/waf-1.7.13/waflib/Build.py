...
class BuildContext(Context.Context):
	...
	def __init__(self, **kw):
		...
		i.e. allows sharing of temporary build data for a selected group builds.
		"""

	def get_variant_dir(self):
		"""Getter for the variant_dir attribute"""
		if self.options.project_spec:
			if self.spec_force_individual_build_directory(self.options.project_spec):
	...
	def load_envs(self):
		...
		self.set_supported_platforms(self.env['build_relevant_platforms'])
